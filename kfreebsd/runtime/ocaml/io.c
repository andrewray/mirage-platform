...
CAMLprim value caml_ml_output_partial(value vchannel, value buff, value start, value length);
CAMLprim value caml_ml_output(value vchannel, value buff, value start, value length);
...
CAMLprim value caml_ml_input(value vchannel, value buff, value vstart, value vlength);
...
#if defined(__FreeBSD__) && defined(_KERNEL)
void console_printf(const char *data, unsigned int length);
#endif
...
#if defined(__FreeBSD__) && defined(_KERNEL)
void
console_printf(const char *data, unsigned int length)
{
